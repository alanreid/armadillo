...
import armadillo.categorizer.plugins.wordlist.WordlistTokenFileFormatter._
...
import armadillo.categorizer.plugins.wordlist.CSVParser._
...
object CSVParser {
  ...
  val CATEGORIZER_CSV_FOLDER = "src/main/resources/csv/"
