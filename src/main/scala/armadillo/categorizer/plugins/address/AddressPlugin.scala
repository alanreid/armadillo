package armadillo.categorizer.plugins.address

import armadillo.categorizer.{Plugin, Token}
import armadillo.categorizer.providers.geo.UsigLocationProvider
import armadillo.categorizer.providers.geo.GeoLocation
